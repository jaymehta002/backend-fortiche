...
const sendResetPasswordEmail = async (to, resetToken) => {
  ...
  const content = `
  <div class="email-container" style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 8px; overflow: hidden;">
    <div class="header" style="background-color: ${GREEN_COLOR}; color: #fff; padding: 20px; text-align: center;">
      <h1 style="margin: 0; font-size: 24px;">Reset Your Password</h1>
    </div>
    <div class="content" style="padding: 20px;">
      <h2 style="margin-top: 0; font-size: 20px; color: #333;">Hello!</h2>
      <p style="line-height: 1.6; font-size: 16px;">We received a request to reset your password. Click the button below to set a new password:</p>
      <div style="text-align: center; margin: 20px 0;">
        <a href="${resetToken}" style="background-color: ${GREEN_COLOR}; color: #fff; padding: 12px 20px; text-decoration: none; font-size: 16px; border-radius: 5px; display: inline-block;">
          Reset Password
        </a>
      </div>
      <div class="highlight-box" style="background-color: #f8f9fa; padding: 15px; border-left: 4px solid ${GREEN_COLOR}; border-radius: 5px; margin-top: 20px;">
        <p style="margin: 0; line-height: 1.6; font-size: 14px;">If you didn't request this change, please ignore this email or contact support if you have concerns.</p>
        <p style="margin: 10px 0 0; line-height: 1.6; font-size: 14px;">This link will expire in 1 hour for security reasons.</p>
      </div>
    </div>
    <div class="footer" style="background-color: #f1f1f1; color: #666; text-align: center; padding: 10px; font-size: 12px;">
      <p style="margin: 0;">If you need further assistance, contact our <a href="#" style="color: ${GREEN_COLOR}; text-decoration: none;">support team</a>.</p>
    </div>
  </div>
`;
  ...
  const content = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <p style="color: #666;">If you have any questions about your order, please contact our support team at <a href="mailto:support@fortiche.com" style="color: ${GREEN_COLOR};">support@fortiche.com</a></p>
      </div>
